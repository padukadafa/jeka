...
import 'package:jeka/di.dart' as _i22;
...
import 'package:jeka/features/settings/presentation/blocs/bloc/settings_bloc.dart'
    as _i12;
import 'package:jeka/features/user/data/remote/user_data_remote.dart' as _i13;
...
import 'package:jeka/features/user/data/repository/user_repository_impl.dart'
    as _i18;
import 'package:jeka/utils/uploud_service.dart' as _i11;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i11.UploadService>(
        () => _i11.UploadService(gh<_i4.Reference>()));
    gh.singleton<_i12.SettingsBloc>(
        () => _i12.SettingsBloc(gh<_i9.SettingsRepository>()));
    gh.singleton<_i13.UserDataRemote>(() => _i14.UserDataRemoteImpl(
          gh<_i6.FirebaseFirestore>(),
          gh<_i7.FirebaseMessaging>(),
          gh<_i5.FirebaseAuth>(),
          gh<_i11.UploadService>(),
        ));
    gh.singleton<_i15.AuthDataRemote>(() => _i16.AuthDataRemoteImpl(
          gh<_i5.FirebaseAuth>(),
          gh<_i13.UserDataRemote>(),
          gh<_i8.GoogleSignIn>(),
        ));
    gh.factory<_i17.UserRepository>(
        () => _i18.UserRepositoryImpl(gh<_i13.UserDataRemote>()));
    gh.singleton<_i19.AuthRepository>(
        () => _i20.AuthRepositoryImpl(gh<_i15.AuthDataRemote>()));
