...
class _$InitialImpl implements _Initial {
  ...
  @override
  String toString() {
    return 'CreateCommunityState.initial(name: $name, logo: $logo, desc: $desc, province: $province, provinceId: $provinceId, regency: $regency, types: $types, rules: $rules, page: $page)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return initial(
        name, logo, desc, province, provinceId, regency, types, rules, page);
  }
...
abstract class _Initial implements CreateCommunityState {
  const factory _Initial(
      ...
      final dynamic page}) = _$InitialImpl;
